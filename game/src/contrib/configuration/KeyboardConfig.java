...
public class KeyboardConfig {
    ...
    public static final ConfigKey<Integer> EQUIPMENT_SLOT =
            new ConfigKey<>(
                    new String[] {"skill", "equipment_slot"}, new ConfigIntValue(Input.Keys.Q));
    public static final ConfigKey<Integer> SKILL_SLOT_1 =
            new ConfigKey<>(
                    new String[] {"skill", "skill_slot_1"}, new ConfigIntValue(Input.Keys.NUM_1));
    public static final ConfigKey<Integer> SKILL_SLOT_2 =
            new ConfigKey<>(
                    new String[] {"skill", "skill_slot_2"}, new ConfigIntValue(Input.Keys.NUM_2));
